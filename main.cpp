...
As prime numbers are not exactly predictable by any mathematical function, he 
has requested help in making a program than can compute the indices within the 
set of primes.
